<?php 
	...
	$opcion = "sistemaAdminPedidoVerClientes";
?>
...
#corner1 {
	position:absolute;
	background-image: url(source/corner1.png);
	width: 24px;
	height:21px;
}
#tabletop {
	position:absolute;
	background-image: url(source/table_top.png);
...
#corner2 {
	position:absolute;
	background-image: url(source/corner2.png);
	width: 28px;
	height:21px;
	z-index:2;
	left: 996px;
...
#tablelft {
	...
	left:0px;
	top:21px;
	background-image:url(source/table_left.png);
	width: 24px;
	height: 718px;
	z-index:2;
}
...
#tableright {
	...
	width:28px;
	height: 718px;
	background-image:url(source/table_right.png);
...
#tablebottom{
	...
	left: 0px;
	top: 630px;
	background-image: url(source/sombra.png);
}
#corner3 {
	position:absolute;
	background-image:url(source/corner4.png);
	width:24px;
	height:29px;
	z-index:1;
	left: 0px;
...
#bottom{
	position:absolute;
	background-image: url(source/table_bottom.png);
	background-repeat:repeat-x;
	width:972px;
	height:29px;
	z-index:2;
...
#corner4 {
	position:absolute;
	background-image:url(source/corner3.png);
	width:28px;
	height:29px;
	z-index:3;
	left: 996px;
...
<body  onload="cargarBuscarClienteVerClientes('<?php echo "$opcion"; ?>','divClientesBusquedaHeaderContedor');">
...
<div id="principal">
<div id="pie">
    <div id="divConteFaceGrup">
      <div id="divIcoFaceImg"><img src="../img/icono-face.jpg" width="38" height="38" /></div>
      <div  class="face" id="divNCenFacebook">New Colors <label class="face2">en facebook</label></div>
      <div id="divMeGustaImg"><img src="../img/me-gusta-face.jpg" width="73" height="25" /></div>
    </div>
    <div id="divContenidoDatosGR">
      <div id="divDatosGR1"><span class="info"><a href="#">Inicio</a></span><span class="style2">| </span><span class="info"><a href="file:///C|/Users/vickyu/Documents/VICTORIA/8°/MULTIMEDIA/DREAMWEAVER/#">Ayuda</a> / <a href="#">Contacto</a></span> <span class="style2">|<span class="info"><a href="#"> Localizar Tiendas</a></span></span></div>
      <div  class="info"id="divDatosGR2">Busqueda Avanzada| Ordenar por Teléfono+52(33)3609 4304</div>
      <div id="divDatosGR3"><span class="info">© 2012 new colors shoes. Todos los Derechos Reservados</span></div>
    </div>
    <div id="divConNoticias">
      <div id="divConNoticias1"><span class="info">Noticias &amp; Actualizaciones</span></div>
      <div id="divConNoticias2">
        <label>
          <input  class="barraTexMenPrin" type="text" name="textfield" id="textfield" />
        </label>
      </div>
      <div id="divConNoticias3"><img src="../img/search-1.jpg" width="56" height="17" />
        <div  class="whiteinfo" id="divConNoticias3_1">Suscribete</div>
      </div>
    </div>
  </div>
  ...
  <div id="diVLineaSSeparadorINd"><img src="../menu/menu/linea.png" width="935
  " height="7" border="0" usemap="#Map5" />
  ...
  <div id="divClientesBusquedaBtnBuscar" class="formatoGen" onclick="cargarBuscarClienteVerClientes('<?php echo "$opcion"; ?>','divClientesBusquedaHeaderContedor');"><a href="#"><img src="../img/btn_buscar.jpg" width="65" height="18" border="0" /></a></div>
  <div id="divImgBusTexto"><img src="../img/ver_clientes.jpg" width="151" height="33" /></div>
              </div>
