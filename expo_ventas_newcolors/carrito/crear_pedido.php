...
// crear_pedido.php?idCliente="+idCliente+"&sitioPedido='Web'&idVendedor=1&TotalPares="+subtotalPares+"&subtotal="+subtotal+"&datos="+datos
	...
	$carrito=new carrito();
//	echo $idTienda;
	$divDatos=$carrito->registra_pedido_por_cliente($idTienda,$sitioPedido,$idVendedor,$TotalPares,$subtotal,$datos,$seccionCatalogo,$txtPedidoCargo,$comboLugarPedido);
