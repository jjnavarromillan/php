...
<div class="datosFormatoGenClientes" id="divPedidoDetalleAtras" onclick="document.getElementById('divGridPedidosClientesContenedorB88').style.visibility='visible';document.getElementById('divGridPedidosClientesContenedor288').style.visibility='hidden';">Regresar</div>
...
<div id="apDiv1"  class="formatoGen"><img src="../img/btn-imprimir.jpg" width="76" height="18" border="0" /></div></a>
</body>
</html>