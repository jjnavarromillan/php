...
GROUP BY pedidos.idPed, detallistas_clientes.nombre, detallistas_tiendas.tienda, pedidos.fechaPedido, pedidos.sitioPedido, detallistas_tiendas.idCliente, detallistas_tiendas.idTienda, pedidos.idVendedor, pedidos.surtido order by  pedidos.fechaPedido ";
	...
	?>
                <a href="#"  onclick="llamarasincrono('vista_pedidos_detalle_clon.php?idPedido=<?php  echo "$idPed"; ?>&foto=Si&txtCliente=<?php  echo "$nombre"; ?>&txtTienda=<?php  echo "$tienda"; ?>&txtFechaPedido=<?php  echo "$fechaPedido";?>&idTienda=<?php  echo "$idTienda";?>','divGridPedidosClientesContenedor2');document.getElementById('divGridPedidosClientesContenedor2').style.visibility='visible';document.getElementById('divGridPedidosClientesContenedorB').style.visibility='hidden';" >
                
                <div id="divRptPedidosClientes">
                  ...
                  <div id="divRowCliente" class="datosFormatoGenClientes"><label id="lblCliente"><?php  echo "$nombre"; ?></label>
                    <div id="divLinieaSeparadorVPedidos"><img src="../menu/menu/linea.png" width="980" height="7" /></div>
                  </div>
