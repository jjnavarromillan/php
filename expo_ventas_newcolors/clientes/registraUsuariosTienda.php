...
<div id="divContenedorRegistraClientes">
  <div id="divNuevoCliRegistraClientes"><img src="img/nuevo-cliente.jpg" width="187" height="36" /></div>
  <div id="divConSecuTIenda">
    <div  class="datosClienteTienda"id="divClienteResgistraCli" >
      <input class="campoTxtTipo" align="left" name="txtCliente" type="text" id="txtCliente" size="45" disabled="true" />
    ...
    <div id="divConCrearUsuWebTienda">
      <div  class="datosClienteTienda" id="divEmail2RegistraClie">
        <div align="left">
          <input class="campoTxtTipo" type="text" name="txtCorreoRegUser" id="txtCorreoRegUser"  />
        </div>
       
          
        </label>
      </div>
      <div  class="datosClienteTienda" id="divContrasenaCliente">
        <div align="left">
          <input  class="campoTxtTipo" type="text" name="txtPasswdRegUser2" id="txtPasswdRegUser2" size="15" />
        </div>
      </div>
      <div id="divCrearURegistraCli"><img src="img/crear-usuario-web-img.jpg" width="169" height="26" /></div>
      ...
      <div id="divCrearUsuario" onclick="crearUsuario();"><a href="#"><img src="img/btn_guadar_usuario.jpg"  border="0" width="169" height="26" /></a></div>
      <div id="divGenerarTienda"><a href="#"><img src="img/btn_generar.jpg" border="0" width="66" height="26" onclick="document.getElementById('txtPasswdRegUser2').value = getRandom();" /></a></div>
      <div  class="datosClienteTienda" id="divEmaClieTienda">EMAIL:</div>
      <div  class="datosClienteTienda"id="divNameClieTienda">NOMBRE:</div>
      <div  class="datosClienteTienda" id="divContClieTienda">CONTRASE&Ntilde;A: </div>
    </div>
    <div id="divUsuarioCombos">
      <select name="comboUsuarios" size="5" id="comboUsuarios"  class="combos">
    ...
    <div id="divBtnCopiarDatos" class="datosClienteTienda" onclick="copiarDatosClienteATienda();">Copiar</div>
  </div>
</div>
<p>&nbsp;</p>
