...
onmouseout="this.style.filter='alpha(opacity=100)';this.style.MozOpacity=1;document.body.style.cursor = 'default'" onClick="eliminarElementosCarritoAll(document.getElementById('idCliente').innerHTML)">Limpiar carro</div>
  ...
  <div class="infoPrecio2" id="divVerCatalogoInventario"><a href="#" onclick="llamarasincrono('http://201.120.55.76/sistema2011/carrito/ver_estilos_diseno_inventario.php','cuadroEstilo');"> Muestrario</a></div>
  <div id="apDiv4">Sugerencias</div>
    </div>
<p>&nbsp;</p>
      ...
      <div id="cuadroresumen" class="cuadroresumen" ><label id='lblCantidadEnCarrito'>0</label></div>
      </div>
