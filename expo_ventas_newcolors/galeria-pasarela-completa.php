...
<div id="divPrGaleriaPasaCompleta">
  <div id="divBotGaleriaAtras" onClick="previewPagParalela();"><a href="#"><img src="img/atras-galeria.jpg"  border="0"width="27" height="51" /></a></div>
...
<div id="divBotGaleriaAdelante" onClick="nextPagPasarela();"><a href="#"><img src="img/adelante-galeria.jpg"  border="0" width="27" height="51" /></a></div>
<img src="img/fondo-galeria-siguenos.jpg" width="703" height="346">
<div id="apDiv2">
  <div class="todasTipoBlanco" align="center">20</div>
</div>
<div id="apDiv1">
  <div  class="todasTipoBlanco" align="center"> <div id="avPagGaleria" align="center"><?php  echo $idxPag; ?></div></div>
</div>
</div>       
