...
ClassDataGridNC.prototype={
	...
	agregarRowFormat:function(tabla,objJSONt,i){
			...
			if(document.getElementById("verFoto").checked){
				cadena = cadena + "<td class='classColumnFoto'><img src='../imagenes_system/muestras/miniminis/"+this.nameFotoImageGif(objJSONt[i].Estilo,objJSONt[i].Material,objJSONt[i].Color)+"' width='48' height='48'></td>";
			}
			for(x=0;x<columnas.length;x++){
