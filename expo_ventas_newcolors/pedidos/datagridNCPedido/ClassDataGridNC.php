...
<script language="javascript" src="ClassDataGridNC.js"></script>
<script language="javascript">

	var midatagridNC = new ClassDataGridNC("midatagridNC");
    midatagridNc.setNameDivDatosDataGrid("divDatosDataGrid");
	midatagridNC.verMensaje();
...
<div id="divDataGrid">
  <input name="verFoto" type="checkbox" onClick="midatagridNC.actualizarVistaTabla();" id="verFoto" checked />
  ...
  <div id="divBotVerDatos"><a href="#"  onClick="midatagridNC.cargarJSON();"><img src="../../carrito/img/ver-datos.jpg" border="0" width="55" height="20" /></a></div>
  <div id="divBotQuiUlFiltro"><a href="#" onclick="midatagridNC.quitarUltimoFiltro();"/><img src="../../carrito/img/quitar-ultimo-filtro.jpg"  border="0"width="112" height="19" /></a></div>
</div>
