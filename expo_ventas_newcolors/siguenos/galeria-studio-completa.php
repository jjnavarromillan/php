...
<div  class="todasTipoBlanco"id="divNumFiStudio">
  <div  id="noPags" align="center">20</div>
</div>
<div  class="todasTipoBlanco"id="divNumInStudio">
  <div id="avPag" align="center">1</div>
</div>
...
<div id="divBotGaleriaAdelanteStudio" onClick="nextPagSiguemeStudioComVista();"><a href="#"><img src="img/adelante-galeria.jpg"  border="0" width="27" height="51" /></a></div>
</div>
<p>&nbsp;</p>
</body>
</html>
